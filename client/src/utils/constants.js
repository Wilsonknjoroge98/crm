...
// Two-letter postal codes keyed by the full names in STATES. The business
// state filter shows codes in its trigger but sends full names to the API,
// which validates them against the same list server-side.
...
export const STATE_OPTIONS = STATES.map((name) => ({
  name,
