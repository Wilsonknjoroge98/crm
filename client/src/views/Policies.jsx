  ...
  return (
    <Container sx={{ mt: 4 }}>
      ...
      >
        ...
        <Button variant='contained' color='action' startIcon={<AddIcon />}>
          New Policy
        </Button>
      </Stack>
      ...
      <Alert severity='warning' sx={{ mb: 3 }}>
        ...
        not appear due to a temporary sync issue. If you don’t see a policy you
        just created, please refresh the page or contact support.
      </Alert>
