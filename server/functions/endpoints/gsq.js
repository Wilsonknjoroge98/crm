...
gsqRouter.get('/reviews/unmatched', async (req, res) => {
  try {
    ...
    logger.error('Error fetching unmatched reviews', { error });
    console.error('Error fetching unmatched reviews:', error);
...
gsqRouter.post('/reviews/match', async (req, res) => {
  try {
    ...
    logger.error('Error matching review to agent', { error });
    console.error('Error matching review to agent:', error);
    res.status(500).send({ message: 'Internal server error' });
  }
});
...
gsqRouter.delete('/reviews/unmatched/:reviewId', async (req, res) => {
  try {
    ...
    logger.error('Error dismissing unmatched review', { error });
    console.error('Error dismissing unmatched review:', error);
    res.status(500).send({ message: 'Internal server error' });
  }
});
