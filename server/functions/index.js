...
const { getHyrosSource } = require("./helpers");
...
exports.inboundGSQLead = functions.https.onRequest(async (req, res) => {
    try {
    ...
    // ADD gsqId
        ...
        const { data, error } = await supabaseService.from('leads').insert(payload);
